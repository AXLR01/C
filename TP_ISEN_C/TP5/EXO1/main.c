...
/* Pour les fonctions initTab2 et afficheTab2 le résonnement est le même que pour les fonctions précedentes sauf que l'on passe par des variables pour la fin des boucles */
