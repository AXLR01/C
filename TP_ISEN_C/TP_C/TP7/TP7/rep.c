...
/* é permet de forcer l'encodage du caractère 'é' à la valeur hexa 0x82 */
...
void main(int argc, char *argv[])
{
	...
	printf("\nsetlocale : %s\n",setlocale(LC_ALL, ".1252")); /* option de localisation pour les caractères accentués  */
	//setlocale(LC_ALL, ""); /* option de localisation pour les caractères accentués  */
...
int saisie_enreg(Enregistrement *enr)
{
  ...
  /********************************************************************************/
  /*  Affichage paginé du répertoire par façon commane DOS 'more'                 */
  /********************************************************************************/
